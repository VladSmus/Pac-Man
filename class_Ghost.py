...
inky_img = pygame.transform.scale(pygame.image.load(f'ghost_images/Inky.png'), (45, 45))
dead_img = pygame.transform.scale(pygame.image.load(f'ghost_images/dead.png'), (45, 45))
spooked_img = pygame.transform.scale(pygame.image.load(f'ghost_images/spooked.png'), (45, 45))
